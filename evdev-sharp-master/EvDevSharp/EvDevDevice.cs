...
public unsafe sealed partial class EvDevDevice : IDisposable
{
    ...
    public delegate void OnCustomKeyEventHandler(object sender, OnKeyEventArgs e);
    ///<summary>This event is for custom key events.</summary>
    public event OnCustomKeyEventHandler? OnCustomKeyEvent;

    public void TriggerCustomKeyEvent(EvDevKeyCode keyCode, EvDevKeyValue value)
    {
        Console.WriteLine($"Custom key event: {keyCode} {value}");
        OnCustomKeyEvent?.Invoke(this, new OnKeyEventArgs(keyCode, value));
    }

    public void TriggerKeyEvent(EvDevKeyCode keyCode, int value)
    {
        OnKeyEvent?.Invoke(this, new OnKeyEventArgs(keyCode, (EvDevKeyValue)value));
    }

    public void TriggerSynEvent()
    {
        OnSynEvent?.Invoke(this, new OnSynEventArgs(EvDevSynCode.SYN_REPORT, 0));
    }
